...
public class Test09 {
	public static void main(String[] args) {
		...
		try {
			...
			String hql = "select pro.name from hibernate.package02.Product pro where "
					+ "pro.price>(select avg(price) from hibernate.package02.Product)";
	...
	public static void showList(List list) {
		...
		while (it.hasNext()) {
			...
			System.out.print("大于平均价格的产品名称：" + arr);
